...
export const skillSchema = z.object({
  ...
  stack: z.nativeEnum(StackType).refine((val) => Object.values(StackType).includes(val), {
    message: "O tipo de stack deve ser um dos valores: frontend, backend, mobile, design, devOps, other",
  }),
  type: z.nativeEnum(SkillType).refine((val) => Object.values(SkillType).includes(val), {
